...
public final class Sistema extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        JpnVenta.setBackground(new java.awt.Color(0, 204, 51));
        ...
        JpnVenta.add(btnCancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 380, -1, -1));
        ...
        JpnProveedores.add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(285, 57, 558, 310));
        ...
        JpnProveedores.add(jPanel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 50, 260, 320));
        ...
        JpnProductos.add(jScrollPane4, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 50, 590, 330));
        JpnProductos.add(txtIdproducto, new org.netbeans.lib.awtextra.AbsoluteConstraints(223, 25, -1, -1));

        jPanel11.setBackground(new java.awt.Color(255, 229, 140));
        ...
        JpnProductos.add(jPanel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 50, 250, 330));

        jTabbedPane1.addTab("4", JpnProductos);

        JpnVentas.setBackground(new java.awt.Color(255, 117, 86));
        ...
        JpnVentas.add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 390, -1, -1));
        ...
        JpnUsuarios.add(jPanel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 40, 280, 380));
        ...
        JpnUsuarios.add(jScrollPane6, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 40, 540, 380));

        jTabbedPane1.addTab("7", JpnUsuarios);
...
if (txtIdVenta.getText().equals("")) {
            ...
            Vdao.abrirpdf(v.getId(), v.getCliente(), v.getTotal(), v.getVendedor());
        }
    ...
    private void btnGuardarproActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarproActionPerformed
        ...
        if ("".equals(txtCodigoPro.getText()) || "".equals(txtDesPro.getText())
            ...
            //Muestra un mensaje de advertencia si algun campo esta vacio
            JOptionPane.showMessageDialog(null, "Los campos están vacíos");
        } else {
            //Verifica si el codigo ya esta registrado
            String codigo = txtCodigoPro.getText();
            if (proDao.existeCodigo(codigo)) {
                //Muestra un mensaje si el codigo ya esta registrado
                JOptionPane.showMessageDialog(null, "El código ya está registrado");
                LimpiarProductos();
            } else {
                //Si el codigo no esta registrado, procede a registrar el producto
                pro.setCodigo(codigo);
                pro.setNombre(txtDesPro.getText());
                Combo itemP = (Combo) cbxProveedorPro.getSelectedItem();
                pro.setProveedor(itemP.getId());

                //Convierte los campos a numeros despues de asegurarte de que no estan vacios
                pro.setStock(Integer.parseInt(txtCantPro.getText()));
                pro.setPrecio(Double.parseDouble(txtPrecioPro.getText()));
        ...
        if (TableVenta.getRowCount() > 0) {
            ...
            if (!"".equals(txtNombreClienteventa.getText())) {
                ...
                if (resultado == 1) {
                    ...
                    if (idVenta > 0) {
                        //Generar el PDF usando el ID de la venta
                        ...
                        JOptionPane.showMessageDialog(null, "Error: ID de venta no generado.", "Error", JOptionPane.ERROR_MESSAGE);
                    }
                } else {
    ...
    private void RegistrarVenta() {
        ...
        //Creamos una lista de detalles de la venta
        List<Detalle> detalles = new ArrayList<>();
        for (int i = 0; i < TableVenta.getRowCount(); i++) {
            int codigo_pro = Integer.parseInt(TableVenta.getValueAt(i, 0).toString());
            int cant = Integer.parseInt(TableVenta.getValueAt(i, 2).toString());
        ...
        //Llamamos al metodo que maneja la venta y los detalles
        int resultado = Vdao.RegistrarVentaConDetalle(v, detalles);
        if (resultado == 1) {
            //Si la venta se registro correctamente, se genera el PDF
            Vdao.pdfV(v.getId(), cliente, Totalpagar, LabelVendedor.getText());
            LimpiarTableVenta();  //Limpiar la tabla de venta
            LimpiarClienteventa();  //Limpiar campos de cliente
        } else {
